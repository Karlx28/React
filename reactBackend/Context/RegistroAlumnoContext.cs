...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Data Source=ILYBE\\SQLEXPRESS;Initial Catalog=registroAlumno;User ID=SugarS;Password = l4luzp0dr4;Trust Server Certificate=True");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Alumno>(entity =>
        {
            entity.HasKey(e => e.Id).HasName("PK__alumno__3213E83FC08322D2");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__asignatu__3213E83F6F3D67C1");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__califica__3213E83FE00227A1");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__matricul__3213E83F63084234");
        ...
        {
            entity.HasKey(e => e.Usuario).HasName("PK__profesor__9AFF8FC75B21B641");
